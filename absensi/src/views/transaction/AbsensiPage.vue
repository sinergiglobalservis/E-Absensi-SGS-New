    ...
    <ion-page>
        <ion-content :fullscreen="true">
            ...
            <div id="dashboard-container">
                ...
                <div class="tx-center">
                    <!-- <IonButton type="button" @click="absen">Hadir</IonButton> -->
...
export default {
    props: [],
    components: { IonContent, IonPage, IonButton, IonIcon, IonTextarea },
    data() {
        return {
    ...
    methods: {
        getJadwal() {
            ...
            const fullHours = dt.getHours() + ':' + dt.getMinutes() + ':' + dt.getSeconds();
            const fullHoursMax = (dt.getHours() + 1) + ':' + dt.getMinutes() + ':' + dt.getSeconds();
            ...
            // console.log(post)
            return axios.post(process.env.VUE_APP_API_URL + 'trx/schedule/getScheduleByUserId', post)
                .then(async (response) => {
                    // binding data
                    ...
                    if (fullHours > this.schedule_in && fullHoursMax < this.schedule_in) {
                        this.terlambat = 1
                        const toast = await toastController.create({
                        ...
                        await toast.present();
                    } else if (fullHours > this.schedule_in) {
                        const toast = await toastController.create({
                            message: 'Anda datang terlambat',
                            duration: 5000,
                            position: 'top'
        ...
        absen: async function () {
            ...
            if (this.terlambat == 1) {
                ...
                await axios.post(process.env.VUE_APP_API_URL + 'trx/absence/add', izin)
                    .then((r) => {
                        // console.log(r);
